                        ...
                        <tbody>
                            @foreach ($data as $i => $item)
                                <tr>
                                    ...
                                    <td>
                                        Success percobaan ke-{{ $item->percobaan_terbaik }}
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-outline-primary btn-detail" data-bs-toggle="modal"
                                            data-bs-target="#detailModal" data-nama="{{ $item->user->siswa->nama_siswa }}"
                                            data-nilai="{{ $item->nilai }}" data-percobaan="{{ $item->total_percobaan }}"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            buttons.forEach(btn => {
                ...
                btn.addEventListener('click', function() {
                    ...
                    document.getElementById('modalNilai').innerText =
                        this.dataset.nilai;

                    document.getElementById('modalStatus').innerHTML =
                        this.dataset.status === 'LULUS' ?
                        '<span class="badge bg-success">LULUS</span>' :
                        '<span class="badge bg-danger">REMEDIAL</span>';

                    document.getElementById('modalPercobaan').innerText =
                        this.dataset.percobaan + 'x';

                    document.getElementById('modalTerbaik').innerText =
                        'Percobaan ke-' + this.dataset.terbaik;

                    const riwayat = JSON.parse(this.dataset.riwayat);
